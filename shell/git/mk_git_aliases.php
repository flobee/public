...
function gitaliases( $test, $configFile = false ) {
    ...
    /**
        // off: 2025-04, json5 now the primary used config
        //
        //     $aliases = array(
        ...
        //                 #- this is _not_ equivalent to getting the last committed
        ...
        //
        //                 # git sm-diff will diff the master repo _and_ its submodules
    ...
    */
    ...
    $json5 = file_get_contents( __DIR__ . '/mk_git_aliases.shared-config.json5' );
